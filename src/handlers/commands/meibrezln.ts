...
export default (bot: TelegramBot): void => {
	bot.onText(commandRegex("meibrezln"), async (msg) => {
		...
		let comment =
			"I schätze, du vaschenkst ned vui vo deine Brezln... und dei Freinde aa ned. &#x1F62A;";
		...
		if (brezls < 25) {
			...
			comment =
				"Na servas, i bin beeindruckt! Wia hosd du so vui Brezln vadeant?! Handelst du mid Krypto oda wos?! &#x1F640;";
